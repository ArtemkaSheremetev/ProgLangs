...
public:
  enum {
    ...
    T__44 = 45, BoolLiteral = 46, StringLiteral = 47, CharLiteral = 48, 
    HexLiteral = 49, BitsLiteral = 50, DecimalLiteral = 51, ID = 52, WS = 53, 
    LINE_COMMENT = 54, BLOCK_COMMENT = 55
  };

  enum {
    RuleSource = 0, RuleSourceItem = 1, RuleFuncDef = 2, RuleParamList = 3, 
    RuleParam = 4, RuleBody = 5, RuleBlock = 6, RuleTypeRef = 7, RuleBuiltinType = 8, 
    RuleCommaList = 9, RuleStmt = 10, RuleExpr = 11, RuleCmpOp = 12, RuleAddOp = 13, 
    RuleMulOp = 14, RuleUnaryOp = 15, RulePrimary = 16, RuleExprList = 17, 
    RuleLiteral = 18
  };
  ...
  class  SimpleExprContext : public ExprContext {
  public:
    SimpleExprContext(ExprContext *ctx);
  ...
  class  IndexExprContext : public PrimaryContext {
  public:
    IndexExprContext(PrimaryContext *ctx);
  ...
  class  CallExprContext : public PrimaryContext {
  public:
    CallExprContext(PrimaryContext *ctx);
  ...
  class  IdExprContext : public PrimaryContext {
  public:
    IdExprContext(PrimaryContext *ctx);
